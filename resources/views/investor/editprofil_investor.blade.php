...
@section('content')
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a class="text-dark" href="{{url('/investor/profil')}}">Profil</a></li>
    ...
    <div class="container">
      ...
      <!-- Default box -->
      <form method="post" action="{{url('/investor/profil/'.$investor->id)}}" enctype="multipart/form-data">
        @csrf
        @method('put')
